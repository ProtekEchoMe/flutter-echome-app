...
part 'transfer_out_scan_store.g.dart';

class TransferOutScanStore = _TransferOutScanStore
    with _$TransferOutScanStore;

abstract class _TransferOutScanStore with Store {
  final String TAG = "_TransferOutScanStore";

  final ErrorStore errorStore = ErrorStore();

  final Repository repository;

  _TransferOutScanStore(this.repository);
