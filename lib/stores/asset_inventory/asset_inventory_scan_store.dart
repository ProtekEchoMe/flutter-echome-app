...
part 'asset_inventory_scan_store.g.dart';

class AssetInventoryScanStore = _AssetInventoryScanStore
    with _$AssetInventoryScanStore;

abstract class _AssetInventoryScanStore with Store {
  final String TAG = "_AssetInventoryScanStore";

  final ErrorStore errorStore = ErrorStore();

  final Repository repository;

  _AssetInventoryScanStore(this.repository);
