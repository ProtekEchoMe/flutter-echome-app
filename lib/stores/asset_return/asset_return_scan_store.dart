...
part 'asset_return_scan_store.g.dart';

class AssetReturnScanStore = _AssetReturnScanStore
    with _$AssetReturnScanStore;

abstract class _AssetReturnScanStore with Store {
  final String TAG = "_AssetReturnScanStore";

  final ErrorStore errorStore = ErrorStore();

  final Repository repository;

  _AssetReturnScanStore(this.repository);
