...
mixin _$AssetReturnScanStore on _AssetReturnScanStore, Store {
  ...
  final _$equipmentDataAtom = Atom(name: '_AssetReturnScanStore.equipmentData');
  ...
  final _$checkedItemAtom = Atom(name: '_AssetReturnScanStore.checkedItem');
  ...
  void updateDataSet(
    ...
    final _$actionInfo = _$_AssetReturnScanStoreActionController.startAction(
        name: '_AssetReturnScanStore.updateDataSet');
    try {
